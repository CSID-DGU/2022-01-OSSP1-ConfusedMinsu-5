...
function GraduateGuide() {
    ...
    useEffect(() => {
        Axios.post("/api/graduateGuide/건축공학과/kyoyang").then((res) => {
            if (res.data) {
                setKyoyang(res.data);
            } else {
                alert("failed to");
    ...
    useEffect(() => {
        Axios.post("/api/graduateGuide/건축공학과").then((res) => {
            if (res.data) {
                setMajor(res.data);
            } else {
                alert("failed to");
    ...
    useEffect(() => {
        Axios.post("/api/graduateGuide/건축공학과/grad").then((res) => {
            if (res.data) {
                setGrad(res.data);
            } else {
                alert("failed to");
    ...
    useEffect(() => {
        Axios.post("/api/graduateGuide/건축공학과/sGroup").then((res) => {
            if (res.data) {
                setSGroup(res.data);
            } else {
                alert("failed to");
    ...
    return (
        <>
            <div className="GraduateGuide">
                <h1 className="text-center">건축공학과</h1>
                        ...
                        <div className="component" id="kyoyang_info">
                            <div className="p-3">
                                ...
                                <p>
                                    <h5> <b>MSC(30학점)</b></h5>
                                    <b> &nbsp; &nbsp; &#10004; 수학 필수</b> <br/>
                                    &nbsp; &nbsp; &nbsp; &nbsp;  2015~2020: 공학수학1 또는 산업수학 <br/>
                                    &nbsp; &nbsp; &nbsp; &nbsp; 2021~2022: 산업수학 <br/><br/>

                                    <b>&nbsp; &nbsp; &#10004; 과학 필수</b><br/>
                                    &nbsp; &nbsp; &nbsp; &nbsp; 일반물리학및실험1 <br/><br/>
                                    <b>&nbsp; &nbsp; &#10004; 과학 1개 과목 선택 필수</b><br/>
                                    &nbsp; &nbsp; &nbsp; &nbsp; 일반화학및실험1, 일반화학및실험2,
                                    화학개론, <br/> &nbsp; &nbsp; &nbsp; &nbsp; 일반생물학및실험1, 일반생물학및실험2, 생물학개론, <br/>
                                    &nbsp; &nbsp; &nbsp; &nbsp; 지구환경과학<br/><br/>

                                    <b>&nbsp; &nbsp; &#10004; 전산학 필수</b><br/>
                                    &nbsp; &nbsp; &nbsp; &nbsp; 2021~2022: 프로그래밍기초와실습 <br/><br/>
