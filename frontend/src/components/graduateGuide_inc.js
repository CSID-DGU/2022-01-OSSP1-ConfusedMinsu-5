...
function GraduateGuide() {
  ...
  useEffect(() => {
    Axios.post("/api/graduateGuide/정보통신공학과/kyoyang").then((res) => {
      if (res.data) {
        setKyoyang(res.data);
      } else {
        alert("failed to");
  ...
  useEffect(() => {
    Axios.post("/api/graduateGuide/정보통신공학과").then((res) => {
      if (res.data) {
        setMajor(res.data);
      } else {
        alert("failed to");
  ...
  useEffect(() => {
    Axios.post("/api/graduateGuide/정보통신공학과/grad").then((res) => {
      if (res.data) {
        setGrad(res.data);
      } else {
        alert("failed to");
  ...
  useEffect(() => {
    Axios.post("/api/graduateGuide/정보통신공학과/sGroup").then((res) => {
      if (res.data) {
        setSGroup(res.data);
      } else {
        alert("failed to");
  ...
  return (
      <>
        <div className="GraduateGuide">
          <h1 className="text-center">정보통신공학과</h1>
                ...
                <div className="component" id="kyoyang_info">
                  <div className="p-3">
                    ...
                    <p>
                      <h5> <b>MSC (30학점)</b></h5>
                      <b> &nbsp; &nbsp; &#10004; 수학 필수</b> <br/>
                      &nbsp; &nbsp; &nbsp; &nbsp; 미적분학및연습1, 미적분학및연습2<br/>
                      &nbsp; &nbsp; &nbsp; &nbsp; 2019~2020: 공학수학1 또는 산업수학/ 2021~2022: 산업수학<br/><br/>
