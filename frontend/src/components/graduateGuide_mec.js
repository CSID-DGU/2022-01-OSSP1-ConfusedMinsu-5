...
function GraduateGuide() {
    ...
    useEffect(() => {
        Axios.post("/api/graduateGuide/기계로봇에너지공학과/kyoyang").then((res) => {
            if (res.data) {
                setKyoyang(res.data);
            } else {
                alert("failed to");
    ...
    useEffect(() => {
        Axios.post("/api/graduateGuide/기계로봇에너지공학과").then((res) => {
            if (res.data) {
                setMajor(res.data);
            } else {
                alert("failed to");
    ...
    useEffect(() => {
        Axios.post("/api/graduateGuide/산기계로봇에너지공학과/sGroup").then((res) => {
            if (res.data) {
                setSGroup(res.data);
            } else {
                alert("failed to");
    ...
    return (
        <>
            <div className="GraduateGuide">
                <h1 className="text-center">기계로봇에너지공학과</h1>
                        ...
                        <div className="component" id="kyoyang_info">
                            <div className="p-3">
                                ...
                                <p>
                                    <h5> <b>MSC (30학점)</b></h5>
                                    <b> &nbsp; &nbsp; &#10004; 수학 필수 </b> <br/>
                                    &nbsp; &nbsp; &nbsp; &nbsp; 미적분학및연습1, 미적분학및연습2, 공학선형대수학<br/>
                                    &nbsp; &nbsp; &nbsp; &nbsp; 2015~2020: 공학수학1 또는 산업수학 / 2021~2022: 산업수학<br/><br/>
                                    <b> &nbsp; &nbsp; &#10004; 수학 권장 </b> <br/>
                                    &nbsp; &nbsp; &nbsp; &nbsp; 수치해석및실습, 확률및통계학<br/>
                                    &nbsp; &nbsp; &nbsp; &nbsp; 2021~2022: 공학수학1<br/>
                                    <br/>
