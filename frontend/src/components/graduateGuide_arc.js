...
function GraduateGuide() {
  ...
  useEffect(() => {
    Axios.post("/api/graduateGuide/건축학과/kyoyang").then((res) => {
      if (res.data) {
        setKyoyang(res.data);
      } else {
        alert("failed to");
  ...
  useEffect(() => {
    Axios.post("/api/graduateGuide/건축학과").then((res) => {
      if (res.data) {
        setMajor(res.data);
      } else {
        alert("failed to");
  ...
  useEffect(() => {
    Axios.post("/api/graduateGuide/건축학과/grad").then((res) => {
      if (res.data) {
        setGrad(res.data);
      } else {
        alert("failed to");
  ...
  useEffect(() => {
    Axios.post("/api/graduateGuide/건축학과/sGroup").then((res) => {
      if (res.data) {
        setSGroup(res.data);
      } else {
        alert("failed to");
  ...
  return (
      <>
        <div className="GraduateGuide">
          <h1 className="text-center">건축학과</h1>
