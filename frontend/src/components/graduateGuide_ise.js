...
function GraduateGuide() {
  ...
  useEffect(() => {
    Axios.post("/api/graduateGuide/산업시스템공학과/kyoyang").then((res) => {
      if (res.data) {
        setKyoyang(res.data);
      } else {
        alert("failed to");
  ...
  useEffect(() => {
    Axios.post("/api/graduateGuide/산업시스템공학과").then((res) => {
      if (res.data) {
        setMajor(res.data);
      } else {
        alert("failed to");
  ...
  useEffect(() => {
    Axios.post("/api/graduateGuide/산업시스템공학과/grad").then((res) => {
      if (res.data) {
        setGrad(res.data);
      } else {
        alert("failed to");
  ...
  useEffect(() => {
    Axios.post("/api/graduateGuide/산업시스템공학과/sGroup").then((res) => {
      if (res.data) {
        setSGroup(res.data);
      } else {
        alert("failed to");
  ...
  return (
      <>
        <div className="GraduateGuide">
          <h1 className="text-center">산업시스템공학과</h1>
                ...
                <div className="component" id="kyoyang_info">
                  ...
                  <p>
                    ...
                    <p>
                      <h5> <b>MSC (30학점)</b></h5>
                      <b> &nbsp; &nbsp; &#10004; 수학 필수</b> <br/>
                      &nbsp; &nbsp; &nbsp; &nbsp; 미적분학및연습1, 미적분학및연습2, 공학선형대수학<br/><br/>

                      <b>&nbsp; &nbsp; &#10004; 과학 선택필수</b><br/>
                      &nbsp; &nbsp; &nbsp; &nbsp; 동일 분야 실험1,2과목 중 실험1,2과목 모두 (2개 과목) 선택필수<br/>
                      &nbsp; &nbsp; &nbsp; &nbsp; 일반물리학및실험1, 일반물리학및실험2 <br/>
                      &nbsp; &nbsp; &nbsp; &nbsp; 일반화학및실험1, 일반화학및실험2 <br/>
                      &nbsp; &nbsp; &nbsp; &nbsp; 일반생물학및실험1, 일반생물학및실험2 <br/><br/>

                      <b>&nbsp; &nbsp; &#10004; 전산학 1개 과목 선택필수</b><br/>
                      &nbsp; &nbsp; &nbsp; &nbsp; 프로그래밍기초와실습, 데이터프로그래밍기초와실습, 인공지능프로그래밍기초와실습<br/>
